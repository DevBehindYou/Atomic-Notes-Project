...
- A note application with offline and online cloud storage synchronization. applications will provide encryption over personal data and real-time cloud sync. This note application will give the user total control over their personal data.
